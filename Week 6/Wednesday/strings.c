...
int main(void)
{
    ...
    {
        printf("Excellent. Your name is Bob.\n");
    }
    else if (stricmp(name, "Bob") == 0)
    {
        printf("Your name is *almost* Bob. You should be more precise.\n");
    }
    else
    {
        printf("That's unfortunate. Your name really should be Bob.\n");
    }
